...
<pre>
mv ~/downloads/demohadoop.pem $DOT_CHEF_DIR/demohadoop.pem
...
cookbook_path            [
  ...
  "#{cluster_chef_path}/site-cookbooks",
]
...
You should see all the cookbooks defined in cluster_chef/cookbooks (ant, apt, ...) and cluster_chef/site-cookbooks (hadoop_cluster, ...) listed among 
