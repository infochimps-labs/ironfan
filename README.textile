...
It will kick off a node and then bootstrap it.  By the time it's done, you should be able to see the hadoop dashboard (follow the instructions for proxy setup).
...
* You'll have to run the following one-time command:<pre>
...
* Now you should be able to use broham:<pre>
