...
* Choose a name for your cluster. In this example, the cluster will be called 'zaius' and its url will be http://zaius.yourdomain.com/
...
If you're using HDFS on the ephemeral drives, put the hadoop_cluster::format_namenode_once and maintain_hadoop_cluster::std_hdfs_dirs.rb recipe in below hadoop and before hadoop_master. Nobody will question your courage if you just run the commands manually and re-run the chef-client after.
