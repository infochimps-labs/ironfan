module AwsServiceData
  ...
  AMI_MAPPING =  {
    ...
    %w[us-east-1             32-bit  ebs             infochimps-chef-client    ] => '', # infochimps.chef-client.lucid.east.32bit.20100610a
    ...
    %w[us-east-1             32-bit  ebs             infochimps-scraper-client ] => 'ami-8b3ad1e2', # infochimps.chef-client.lucid.east.32bit.20100610a
