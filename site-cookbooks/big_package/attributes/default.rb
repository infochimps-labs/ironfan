...
default[:pkg_sets][:gems][:dev]       = %w[
  activesupport activemodel extlib json yajl-ruby addressable cheat
  yard jeweler rspec  watchr pry configliere gorillib highline formatador choice ]

default[:pkg_sets][:pkgs][:sysadmin]  = %w[ ifstat htop tree chkconfig sysstat htop nmap ]
