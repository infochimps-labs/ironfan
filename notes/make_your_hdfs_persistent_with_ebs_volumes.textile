...
* detach
* snapshot with a name like @gibbon+raw+000+000+/dev/sdh+/ebsx+20100523@ -- note the snapshot id (eg snap-6a1b8202) and wait for it to finish.
* Create volumes: @ec2-create-volume --size 400 --snapshot snap-6a1b8202 --availability-zone us-east-1d@

sudo mkdir /ebs3
sudo mount -t xfs -o defaults,nouuid,noatime /dev/sdh1 /ebs2

h2. Using Broham to assign drives to their correct instance
