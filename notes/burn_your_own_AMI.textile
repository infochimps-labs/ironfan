...
That is, remove directories from the AMI_EXCLUDES env variables that do not exist. Be careful though because it is a
VERY BAD THING if directories that do exist are not excluded!
