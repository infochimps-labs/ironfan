...
Choose a name for your cluster, and a domain name for your chef server. If you run a standalone chef server, also choose a domain name for the cluster's master node. In this example, we'll be using
