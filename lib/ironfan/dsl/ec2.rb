...
Chef::Config[:ec2_flavor_info].merge!({
    ...
    'r3.xlarge'   => { :price => 0.350, :bits => 64, :ram =>  30720, :cores => 4, :core_size => 3.5,  :inst_disks => 1, :inst_disk_size =>  80, :ephemeral_volumes => 1, :virtualization => 'hvm', :ebs_optimizable => 1000 },
    'r3.2xlarge'  => { :price => 0.700, :bits => 64, :ram =>  61440, :cores => 8, :core_size => 3.5, :inst_disks => 1, :inst_disk_size =>  160, :ephemeral_volumes => 1, :virtualization => 'hvm', :ebs_optimizable => 1000 },
    'r3.4xlarge'  => { :price => 1.400, :bits => 64, :ram =>  124928, :cores => 16, :core_size => 3.5, :inst_disks => 1, :inst_disk_size => 320, :ephemeral_volumes => 1, :virtualization => 'hvm', :ebs_optimizable => 1000 },
