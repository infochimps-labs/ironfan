...
h2. Dedicated Cassandra cluster, high-memory nodes
...
h2. Dedicated Cassandra cluster, medium-memory nodes
...
* 7.5 GB ram, 64-bit, 2 cores
* High IO rate
* single 850 GB local drive mounted as /mnt, ext3-formatted

h2. Cassandra nodes and Hadoop workers on same machines
...
h2. Just screwing around with cassandra: 32-bit, much-too-little-memory nodes
